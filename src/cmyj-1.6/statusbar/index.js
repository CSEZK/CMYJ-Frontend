  ...
  return `
    <main class="cm-panel">
      ...
      <header class="cm-header">
        <div>
          <p class="cm-kicker">残明余烬 · <span class="cm-refresh-time">${html(lastRefreshAt || '--:--:--')}</span></p>
          <h1>${html(buildTabs().find(([id]) => id === activeTab)?.[1] || '状态簿')}</h1>
          <span class="cm-pages-delay-test" title="Cloudflare Pages 更新延迟测试">Pages 测试 · 11:44:33</span>
        </div>
