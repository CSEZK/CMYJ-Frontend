    ...
    <main class="cm-panel">
      ...
      <header class="cm-header">
        <div>
          ...
          <span class="cm-version-badge" title="当前状态栏版本">v${STATUSBAR_VERSION}</span>
        </div>
