...
assert.match(betaStatusbarSource, /STATUSBAR_VERSION = '1\.7\.0-beta\.7'/);
...
assert.match(betaStatusbarSource, /本世界线身份定位/);
assert.match(betaStatusbarSource, /常驻地与活动范围/);
assert.match(betaStatusbarSource, /长期势力归属/);
assert.match(betaStatusbarSource, /角色称呼user/);
assert.match(betaStatusbarSource, /长期相处模式/);
assert.match(betaStatusbarSource, /与其他角色的长期关系/);
assert.match(betaStatusbarSource, /人设适配原则/);
