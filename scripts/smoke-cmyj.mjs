...
assert.match(v19StatusbarSource, /formData\.append\('alternate_greetings', greeting\)/);
assert.match(v19StatusbarSource, /append\('extensions', JSON\.stringify\(extensions\)\)/);
assert.doesNotMatch(v19StatusbarSource, /formData\.append\('alternate_greetings\[\]'/);
