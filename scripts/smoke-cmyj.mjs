...
assert.match(releaseStatusbarSource, /STATUSBAR_VERSION = '1\.8\.5'/);
...
assert.match(releaseWorldEngineSource, /maxPromptChars:\s*42000/);
...
assert.match(releaseWorldEngineSource, /VERSION = '1\.8\.5'/);
