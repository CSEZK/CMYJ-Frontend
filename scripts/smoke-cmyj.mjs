...
assert.match(betaStatusbarSource, /STATUSBAR_VERSION = '1\.7\.0-beta\.10'/);
...
assert.match(betaScenarioSource, /data-identity-preview="identity"/);
assert.match(betaScenarioSource, /写入世界书/);
assert.match(betaScenarioSource, /entry\('\[scenario\]主角身份', identityContent/);
